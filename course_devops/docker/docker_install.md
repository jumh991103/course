...
---
### 오류: REGDB_E_CLASSNOTREG

![alt text](./img/install/image-16.png)

---
#### 해결방법 
1. Windows 기능 활성화 확인 (WSL 관련 컴포넌트) & 윈도우 재부팅
```shell
...
---
2. Linux용 Windows 하위 시스템 & 윈도우 재부팅
![alt text](./img/install/image-17.png)

---
3. [WSL 수동 다운로드 및 설치 & 윈도우 재부팅](https://github.com/microsoft/WSL/releases/tag/2.2.4)
![alt text](./img/install/image-18.png)
...
![w:850](./img/install/image-11.png)

---
7. 설정에서 WSL2 통합 기능이 활성화 되어있는지 확인해봅니다

![w:850](./img/install/image-12.png)
