...
```
![bg right w:600](./img/basic/image-16.png)
...
ls /root # 복사한 파일 확인 
```
![bg right w:600](./img/basic/image-18.png)
...
rm test1.txt
``` 
![bg right w:600](./img/basic/image-20.png)
...
rm -r sample
``` 
![bg right w:600](./img/basic/image-21.png)
